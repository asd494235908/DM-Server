...
const faker_Email = ['554702612@qq.com'] //其他管理员也可以接收有限来确认订单 可以不填
...
function email_init(meailnum, data,token) {
    ...
    let option = {
        num: Number(pirce).toFixed(2)+'RMB',
    ...
    const email_option = {
        ...
        pass: 'vxfubswuekubcbdb',//邮箱的授权码（不会的百度 很简单 POP3/SMTP服务）
    ...
    const mailOptions = {
        ...
        to: email_option.to,
        subject: email_option.subject,
        //text: 'Hello world', // 文本
        html: email_option.html,
    };
